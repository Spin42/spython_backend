...
(function() {
  ...
  if (this.services == null) {
    this.services = angular.module("spython.services", []);
  }

  this.services.factory("Statistics", [
    "$http", function($http) {
      var baseUrl, statisticsUrl;
  ...
  this.services.factory("StatisticsLoader", [
    "Statistics", "$q", function(Statistics, $q) {
      return function() {
        var delay;
        delay = $q.defer();
        Statistics.query().success(function(statistics) {
          return delay.resolve(statistics);
        }).error(function(err) {
          return delay.reject("Unable to fetch statistics: " + err);
        });
...
(function() {
  "use strict";
  this.app = angular.module("spython", ["ngRoute", "spython.services"]);
  ...
  this.app.config([
    "$routeProvider", "$httpProvider", function($routeProvider, $httpProvider) {
      ...
      return $routeProvider.when("/", {
        ...
        resolve: {
          stats: [
            "StatisticsLoader", function(StatisticsLoader) {
...
(function() {
  "use strict";
  this.app.controller("StatsController", [
